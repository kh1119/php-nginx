    ...
    chapter: function () {
      ...
      if ($("#list-chapter").length) {
        ...
        $(".search-reading-item").keyup(function () {
          ...
          $(`#${code}-chapters`).find(".highlight").removeClass("highlight");
          if ($evt.length > 0) {
            $(`#${code}-chapters`).animate(
              {
              ...
              $("#login-state").html(
                ...
                <div class="dropdown">
                  ...
                  `</div>
                      ...
                      <a class="dropdown-item" href="/profile/"><i class="fa fa-user-circle mr-2"></i>${config.lang.pft}</a>
                      <a class="dropdown-item" href="/favorite/"><i class="fa fa-heart mr-2"></i>${config.lang.fav}</a>
                      <!--<a class="dropdown-item" href="/activatekey/"><i class="fa fa-unlock mr-2"></i>${config.lang.premium}</a>-->
            ...
            $("#login-state").html(
              `<div id="user-slot">
                  <div class="header_right-user">
                    <a data-toggle="modal" data-target="#modallogin" class="btn-user btn btn-login"><i class="fas fa-user-circle mr-2"></i>Member</a>
                  </div>
              </div>`
            );
          }
