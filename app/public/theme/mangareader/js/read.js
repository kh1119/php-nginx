  ...
  read = {
    ...
    run: function () {
      ...
      $(".c-select-lang").click(function () {
        ...
        $("#c-selected-lang>.rl-lang-text").text(code.toUpperCase()),
...
$(document).click(function (event) {
  if ($(event.target).closest("#vertical-content").length) {
    ...
    console.log(htop, event.pageY - $(window).scrollTop());
    if (htop > event.pageY - $(window).scrollTop()) {
      $("body,html").animate(
        {
          scrollTop: $(window).scrollTop() - htop,
        },
        200
      );
    } else {
